  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 backdrop-blur-md bg-black/30 border-b border-gray-800">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 py-4 flex items-center justify-between">
        ...
        className="hidden font-semibold md:block bg-gradient-to-r from-orange-500 to-yellow-400 text-black px-4 py-2 rounded-md text-md hover:opacity-90 transition">
          Get Started
        </button>
      </div>
    </header>
